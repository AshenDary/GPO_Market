...
dashboard/
  ...
  components/
    data.py                   cached loaders + pipeline reuse for dashboard tabs
    views.py                  overview/lookup/trend rendering and charting
...
`dashboard/components/data.py`). The sidebar "Refresh data" button clears
...
panels, confidence-band visuals, and tabbed overview/lookup/trend flow).
